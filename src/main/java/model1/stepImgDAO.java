...
public class stepImgDAO {
	...
	public boolean recipeUpload(int rcseq, String strStepNum, MultipartHttpServletRequest multi) {
		...
		String uploadThumbPath = "C:/workspace2/FinalProject_0122/src/main/webapp/picture/" + rcseq + "/Thumb/";
		...
		if (!thumbDir.isDirectory()) {
		 ...
		 String uploadStepPath ="C:/workspace2/FinalProject_0122/src/main/webapp/picture/"+rcseq+ "/Step/";
		...
		String uploadWorkPath ="C:/workspace2/FinalProject_0122/src/main/webapp/picture/"+rcseq+ "/Work/";
